			...
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="panel panel-default">
						...
						$lihat		= mysqli_query($conn, "SELECT * FROM data_siswa WHERE nis_siswa = '$id_siswa'");
								...
								<div class="panel-body">
									<form action="proses_edit.php" method="POST" class="form">
										...
										<div class="form-group">
											...
											<input type="number" name="nis_siswa" class="form-control" value="<?php echo $data['nis_siswa'] ?>" readonly>
										</div>
										<div class="form-group">
